...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Manufacture.url'
        db.alter_column(u'myshop_manufacture', 'url', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Manufacture.url'
        db.alter_column(u'myshop_manufacture', 'url', self.gf('django.db.models.fields.CharField')(max_length=500))
