...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manufacture.logo_front'
        db.add_column(u'myshop_manufacture', 'logo_front',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='manufactures', to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manufacture.logo_front'
        db.delete_column(u'myshop_manufacture', 'logo_front_id')
