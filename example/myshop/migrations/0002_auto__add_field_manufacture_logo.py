...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manufacture.logo'
        db.add_column(u'myshop_manufacture', 'logo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default="", to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manufacture.logo'
        db.delete_column(u'myshop_manufacture', 'logo_id')
