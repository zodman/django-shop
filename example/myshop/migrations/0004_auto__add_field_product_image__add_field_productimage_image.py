...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'myshop_product', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='products', to=orm['filer.Image']),
                      keep_default=False)

        # Adding field 'ProductImage.image'
        db.add_column(u'myshop_productimage', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='productimages', to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.image'
        db.delete_column(u'myshop_product', 'image_id')

        # Deleting field 'ProductImage.image'
        db.delete_column(u'myshop_productimage', 'image_id')
    ...
    models = {
        ...
        u'myshop.manufacture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'manufatures'", 'to': "orm['filer.Image']"}),
            'logo_front': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'manufactures'", 'to': "orm['filer.Image']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        u'myshop.product': {
            ...
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'products'", 'to': "orm['filer.Image']"}),
        ...
        u'myshop.productimage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'productimages'", 'to': "orm['filer.Image']"}),
