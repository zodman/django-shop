...
class FlatRateShipping(object):
    ...
    """
    url_namespace = 'estafeta'
    backend_name = 'Estafeta'
    backend_verbose_name = _('Estafeta')

    def __init__(self, shop):
        self.shop = shop  # This is the shop reference, it allows this backend
        # to interact with it in a tidy way (look ma', no imports!)
        self.rate = getattr(settings, 'SHOP_SHIPPING_FLAT_RATE', '115')
    ...
    def get_urls(self):
        ...
        urlpatterns = patterns('',
            url(r'^$', self.view_display_fees, name='estafeta'),
